...
- Finally settled on using a Linux subsystem on Linux to compile the project (at this point we use a small demo to test the dependencies). Spent about 30min to install SDL2 and compile the project in the subsystem.
